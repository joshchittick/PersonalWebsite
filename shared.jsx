...
const NYC_GEO_ROUTES = [
  {
    ...
    coords: [
      [40.7682, -73.9819], [40.7710, -73.9817], [40.7745, -73.9805], [40.7785, -73.9779],
      [40.7820, -73.9750], [40.7960, -73.9580], [40.7975, -73.9540], [40.7980, -73.9510],
      [40.7960, -73.9490], [40.7910, -73.9510], [40.7820, -73.9580], [40.7720, -73.9700],
      [40.7682, -73.9760], [40.7670, -73.9790], [40.7682, -73.9819],
    ],
    color: "var(--accent)",
  },
  {
    ...
    coords: [
      [40.7115, -74.0145], [40.7220, -74.0125], [40.7330, -74.0095], [40.7440, -74.0070],
      [40.7560, -74.0040], [40.7680, -74.0010], [40.7800, -73.9970], [40.7920, -73.9930],
      [40.8050, -73.9890], [40.8180, -73.9580],
    ],
    color: "#1a1a1a",
  },
  {
    ...
    coords: [
      [40.7128, -74.0060], [40.7115, -74.0023], [40.7095, -73.9990], [40.7060, -73.9960],
      [40.7032, -73.9913], [40.7015, -73.9890], [40.7001, -73.9870], [40.6995, -73.9850],
    ],
    color: "#1a1a1a",
  },
  {
    ...
    coords: [
      [40.7250, -73.9755], [40.7280, -73.9740], [40.7320, -73.9730], [40.7370, -73.9720],
      [40.7420, -73.9715], [40.7470, -73.9700], [40.7520, -73.9680], [40.7565, -73.9660],
    ],
    color: "#1a1a1a",
  },
  {
    ...
    coords: [
      [40.6602, -73.9690], [40.6620, -73.9655], [40.6650, -73.9620], [40.6695, -73.9620],
      [40.6720, -73.9650], [40.6720, -73.9695], [40.6695, -73.9720], [40.6650, -73.9725],
      [40.6620, -73.9715], [40.6602, -73.9690],
    ],
    color: "#1a1a1a",
  },
];
